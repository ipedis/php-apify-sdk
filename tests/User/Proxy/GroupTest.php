...
it('should create group', function (): void {
...
it('should create group from array', function (array $payload): void {
...
it('should throw exception when available count is less than 0', function (): void {
